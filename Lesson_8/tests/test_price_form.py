...
import os
from Lesson_8 import tests, demoqa_tests
import Lesson_8.demoqa_tests.model.controls.dropdown
from Lesson_8.demoqa_tests.model.pages import practice_form
from Lesson_8.demoqa_tests.model.controls.dropdown import select
